...
export const seedStaffMembers: StaffMember[] = [
  ...
  {
    id: "production-manager-haoran",
    name: "浩然",
    username: "haoran",
    role: "production_manager",
    title: "拍摄部门主管",
    active: true,
    passwordSalt: "seed-production-manager-haoran",
    passwordHash: "",
  },
  {
    id: "finance-director-meng",
    name: "孟总",
    username: "meng",
    role: "finance_director",
    title: "财务总监",
    active: true,
    passwordSalt: "seed-finance-director-meng",
    passwordHash: "",
  },
  {
    id: "delivery-manager-yunyun",
    name: "芸芸",
    username: "yunyun",
    role: "delivery_manager",
    title: "交付主管",
    active: true,
    passwordSalt: "seed-delivery-manager-yunyun",
    passwordHash: "",
  },
  {
